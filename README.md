...
| Partition Equal Subset Sum | [Video](https://www.youtube.com/watch?v=ZFuagJEpeEU) | O(n * target) | O(n * target) | Bottom-up (Backtracking) |
| Jump Game | [Video](https://www.youtube.com/watch?v=Yan0cv2cLy8) | O(n) | O(n) | Greedy |
...
| Problem | Video | Time Complexity | Space Complexity | Approach |
|--------|--------|------------------|-------------------|----------|
| Merge Intervals | [Video](https://www.youtube.com/watch?v=44H3cEC2fFM&ab_channel=NeetCode) | O(n log n) | - | Overlapping Intervals |
...
| Detect Cycle in a Linked List | [Video](https://www.youtube.com/watch?v=gBTe7lFR3vc&ab_channel=NeetCode) | O(1) | O(n) | Fast and Slow pointers |
...
| 525. Contiguous Array | [Video](https://www.youtube.com/watch?v=agB1LyObUNE&ab_channel=NeetCodeIO) | O(n) | O(n) | Prefix Sum |
| 560. Subarray Sum Equals K | [Video](https://www.youtube.com/watch?v=fFVZt-6sgyo&ab_channel=NeetCode) | O(n) | - | Prefix Sum |

## Sliding Window

| Problem | Video | Time Complexity | Space Complexity | Approach |
|--------|--------|------------------|-------------------|----------|
| Maximum Average Subarray I | [Video](https://www.youtube.com/watch?v=UdUUnoiLkPg&ab_channel=GregHogg) | O(n) | O(n) | Sliding Window |
