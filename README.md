...
| Longest Palindrome Substring | [Video](https://www.youtube.com/watch?v=XYQecbcd6_c) | O(n**2) | O(1) | Dynamic Programming(Alternative) |
...
| Maximum Twin Sum of a Linked List | [Video](https://www.youtube.com/watch?v=doj95MelfSA) | O(n) | O(1) | slow and fast algorithm |
